...
export default function TestingComponent() {
    return (
        <div> {/*try add className="dashboard" inside the div tag */}
            <h1 className="bg-primary text-number font-serif">Primary Number Lora (bold)</h1>
            <h1 className="bg-primary-dark  text-heading font-serif">Primary-dark Heading Lora (bold)</h1>
            <h1 className="bg-primary-light text-subheading font-mono">Primary-light Subheading Roboto Mono (semibold)</h1>
            <h1 className="bg-secondary text-subheading font-sans">Secondary Subheading Poppins (semibold)</h1>
