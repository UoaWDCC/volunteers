...
function Signup() {
  ...
  const { showModal, setShowModal, setMessage, setError, setMissingFields } =
    useContext(RegisterModalErrorContext);
  const authContext = useContext(AuthenticationContext);
  const { currentUser, uid } = authContext as unknown as {
    currentUser: any;
    uid: string;
    signOut: () => void;
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!validatePhoneNumber(mobile)) {
      ...
      setMessage(
        "Please enter a valid mobile number or enter in the correct format."
      );
      setShowModal(true);
      return;
    }
    ...
    if (!validatePhoneNumber(emergencyContactMobile)) {
      ...
      setMessage(
        "Please enter a valid emergency contact mobile number or enter in the correct format."
      );
      setShowModal(true);
      return;
    }
  ...
  function validatePhoneNumber(phoneNumber: string) {
    ...
    return (
      phonePattern10.test(phoneNumber) ||
      phonePattern11.test(phoneNumber) ||
      phonePattern9.test(phoneNumber)
    );
  }
              ...
              <div className="py-[60px]">
                <div className="bg-white shadow-2xl rounded-t-[1rem] w-[940px] h-[560px] mx-[280px] items-center">
                  <div className="px-[50px] py-[30px]">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <div>
                        <label
                          htmlFor="first_name"
                          className="inline-block text-sm font-medium text-black"
                        >
                          First name
                        </label>
                        <p className="inline-block text-red-600">*</p>
                      ...
                      <div>
                        <label
                          htmlFor="birthday"
                          className="inline-blocktext-sm text-sm font-medium text-black"
                        >
                          Date of Birth
                        </label>
                    ...
                    <div className="mb-6">
                      <label
                        htmlFor="gender"
                        className="inline-block text-sm font-medium text-gray-900 text-black mt-4"
                      >
                        Gender
                      </label>
                      <p className="inline-block text-red-600">*</p>
                      <div className="flex space-x-3">
                        ...
                        <div>
                          <input
                            ...
                            name="gender"
                            onChange={handleGenderChange}
                            checked={gender.includes("non-binary")}
                          />
                          <label
                            htmlFor="non-binary"
                            className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <div>
                          <input
                            ...
                            name="gender"
                            onChange={handleGenderChange}
                            checked={gender.includes("prefernottosay")}
                          />
                          <label
                  ...
                  <div className="bg-slate-100 py-5 rounded-b-[1rem] flex space-x-2 -mt-[36px]">
                    <button
                      type="button"
                      className="select-none cursor-default ml-[717.5px] inline-block border border-slate-100 border-solid text-slate-100 bg-slate-100 hover:bg-slate-100 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center active:translate-y-0.5 transition-all ease-in-out duration-100"
                    >
                      Back
                    </button>
                    <button
                      ...
                      className="inline-block text-white bg-primary hover:bg-primary-dark active:translate-y-0.5 transition-all ease-in-out duration-100 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                    >
                      Next
                    </button>
                  </div>
                ...
                <div className="bg-white shadow-2xl rounded-t-[1rem] w-[940px] h-[560px] mx-[280px]">
                  <div className="px-[50px] py-[30px]">
                    ...
                    <div>
                      <label
                        htmlFor="gender"
                        className="inline-block text-sm font-medium text-gray-900 text-black"
                      >
                        Year Level
                      </label>
                      <p className="inline-block text-red-600">*</p>
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              checked={yearLevel.includes("first")}
                            />
                            <label
                              htmlFor="first"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="yearlevel"
                              onChange={handleYearLevelChange}
                              checked={yearLevel.includes("second")}
                            />
                            <label
                              htmlFor="second"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="yearlevel"
                              onChange={handleYearLevelChange}
                              checked={yearLevel.includes("third")}
                            />
                            <label
                              htmlFor="third"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="yearlevel"
                              onChange={handleYearLevelChange}
                              checked={yearLevel.includes("fourth")}
                            />
                            <label
                              htmlFor="fourth"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="yearlevel"
                              onChange={handleYearLevelChange}
                              checked={yearLevel.includes("postgraduate")}
                            />
                            <label
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="yearlevel"
                              onChange={handleYearLevelChange}
                              checked={yearLevel.includes("otheryear")}
                            />
                            <label
                              htmlFor="otheryear"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 hover:bg-slate-300 hover:shadow-light-2"
                            >
                              Other
                            </label>
                          </div>
                    ...
                    <div>
                      ...
                      <p className="inline-block text-white">*</p>
                      <p className="inline-block text-sm font-medium text-black">
                      ...
                      <div className="flex space-x-3">
                        <div>
                          <input
                            ...
                            checked={dietaryRequirements.includes("vegan")}
                            required
                        ...
                        <div>
                          <input
                            ...
                            className="peer hidden"
                            onChange={handleDietaryChange}
                            checked={dietaryRequirements.includes("vegetarian")}
                            required
                            value={dietaryRequirements}
                          />
                          <label
                        ...
                        <div>
                          <input
                            ...
                            className="peer hidden"
                            onChange={handleDietaryChange}
                            checked={dietaryRequirements.includes("dairyfree")}
                            required
                            value={dietaryRequirements}
                          />
                          <label
                        ...
                        <div>
                          <input
                            ...
                            className="peer hidden"
                            onChange={handleDietaryChange}
                            checked={dietaryRequirements.includes("glutenfree")}
                            required
                            value={dietaryRequirements}
                          />
                          <label
                        ...
                        <div>
                          <input
                            ...
                            className="peer hidden"
                            onChange={handleDietaryChange}
                            checked={dietaryRequirements.includes("halal")}
                            required
                            value={dietaryRequirements}
                          />
                          <label
                        ...
                        <div>
                          <input
                            ...
                            className="peer hidden"
                            onChange={handleDietaryChange}
                            checked={dietaryRequirements.includes(
                              "otherrequirements"
                            )}
                            required
                            value={dietaryRequirements}
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              checked={driversLicense.includes("none")}
                            />
                            <label
                              htmlFor="none"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="license"
                              onChange={handleDriversLicenseChange}
                              checked={driversLicense.includes("learners")}
                            />
                            <label
                              htmlFor="learners"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="license"
                              onChange={handleDriversLicenseChange}
                              checked={driversLicense.includes("restricted")}
                            />
                            <label
                              htmlFor="restricted"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                        ...
                        <li>
                          <div>
                            <input
                              ...
                              name="license"
                              onChange={handleDriversLicenseChange}
                              checked={driversLicense.includes("full")}
                            />
                            <label
                              htmlFor="full"
                              className="select-none cursor-pointer peer-checked:bg-primary peer-checked:text-white border border-slate-300 border-solid inline-block rounded-full bg-white px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-black shadow-light-3 transition duration-150 ease-in-out hover:bg-slate-300 hover:shadow-light-2 focus:bg-slate-300 focus:shadow-light-2 focus:outline-none focus:ring-0 active:bg-neutral-200 active:shadow-light-2 motion-reduce:transition-none"
                    ...
                    <div>
                      <label
                        htmlFor="other_needs"
                        className="inline-block text-sm font-medium text-black mt-4"
                      >
                      ...
                      <input
                        type="text"
                        id="other_needs"
                        className="border border-slate-300 border-solid text-gray-900 text-sm rounded-lg block p-2.5 pr-20"
                        placeholder="Wheelchair access, seafood allergy"
                  ...
                  <div className="bg-slate-100 py-5 rounded-b-[1rem] flex space-x-2 -mt-[6.3px]">
                    <button
                      ...
                      className="ml-[717.5px] inline-block border border-primary border-solid text-primary bg-white hover:bg-slate-100 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center active:translate-y-0.5 transition-all ease-in-out duration-100"
                    >
                      Back
                    </button>
                    <button
              ...
              <div className="py-[60px]">
                <div className="bg-white shadow-2xl rounded-t-[1rem] w-[940px] h-[560px] mx-[280px]">
                  ...
                  <div className="bg-slate-100 py-5 rounded-b-[1rem] flex space-x-2 mt-[176px]">
                    ...
                    <button
                      type="submit"
                      className="inline-block text-white bg-primary hover:bg-primary-dark active:translate-y-0.5 transition-all ease-in-out duration-100 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center" /*disabled={!isValid}*/
                    >
                      Finish
                    </button>
                  </div>
