...
export default function EventCard({ event, onEdit }: EventCardProps) {
    ...
    return (
        <div className="relative dashboard w-fullitems-center m-2 p-4 flex rounded-xl cursor-pointer bg-grey-background transition transform hover:translate-y-0.5 hover:bg-white hover:shadow-sm ease-in duration-100 ">
            {/* Edit Icon - Top Right */}
