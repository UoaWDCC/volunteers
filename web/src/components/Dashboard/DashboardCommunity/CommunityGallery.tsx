...
const CommunityGallery = () => {
  ...
  return (  
      <div className='bg-white rounded-lg py-10 px-[4%] w-full text-subheading text-black shadow-lg'>
          <p>People you may know: </p>
          <div className='w-full grid grid-cols-3 max-[1280px]:grid-cols-2 min-[2100px]:grid-cols-4 min-[2560px]:grid-cols-5 gap-x-4'>
