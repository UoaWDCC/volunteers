...
export default function Event({event, setEventDetails}: EventProps) {
    ...
    return (
        <div onClick={() => setEventDetails(event)} className="dashboard bg-white-background transition transform active:translate-y-0.5 active:duration-100 active:shadow-sm hover:bg-white hover:shadow-sm ease-in duration-100 items-center m-4 flex rounded-xl cursor-pointer"> {/* event-container */}
