...
export default function Event({event, setEventDetails}: EventProps) {
    ...
    return (
        <div onClick={() => setEventDetails(event)} className="dashboard bg-white-background hover:bg-white hover:shadow-sm ease-in duration-500 items-center m-4 flex rounded-xl cursor-pointer"> {/* event-container */}
