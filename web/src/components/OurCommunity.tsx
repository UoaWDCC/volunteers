...
const OurCommunity = () => {
    ...
    const [data, setData] = useState<OurCommunityData>({
      ...
      useEffect(() => {
        // Fetch gallery data
        axios.get('http://localhost:3000/api/homepage/community')
          .then((res) => {
            setData(res.data);
        ...
        <div className="flex flex-col items-center h-screen bg-neutral text-black font-medium">
            ...
            <div className="relative w-full h-screen">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-center text-[5rem] leading-[150%] font-semibold mt-[3.5rem]">{data.volunteerStatistic}</div>
