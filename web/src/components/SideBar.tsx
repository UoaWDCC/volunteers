    ...
    return ( 
        <div className="sidebar">
            ...
            <div className="sidebar-links">
                ...
                <div className={selectedTab === "discover" ? "selected" : "" }>
                ...
                <div className={selectedTab === "profile" ? "selected" : "" }>
                ...
                <div className={selectedTab === "social" ? "selected" : "" }>
                ...
                <div className={selectedTab === "settings" ? "selected" : "" }>
