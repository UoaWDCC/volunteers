        ...
        <div className="flex bg-slate-50 items-center m-2"> {/* event-container */}
            ...
            <div className="inline p-1.5"> {/* event details on the right */}
                ...
                <div className="inline-block items-center py-1 pr-5"> {/* people */}
                    {/* profile image */}
                    <img loading="lazy" className="h-7 w-7 object-cover rounded-full inline" src="../../assets/gallery/events/sample1.png" />
                ...
                <div className="inline-block items-center py-1 pr-5"> {/* people */}
                    ...
                    <img loading="lazy" className="h-7 w-7 object-cover rounded-full inline -ml-2.5" src="../../assets/gallery/events/sample1.png" />
