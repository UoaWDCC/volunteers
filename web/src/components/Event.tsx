    ...
    return (
        <div className="flex bg-slate-50 items-center m-2"> {/* event-container */}
            <div className="inline m-3"> {/* image-container */}
                <img className="h-24 w-40 object-cover rounded-md" src="../../public/assets/gallery/events/sample1.png" />
            </div>
            <div className="inline p-1.5"> {/* event details on the right */}
                ...
                <div className="inline-block items-center py-1 pr-5"> {/* people */}
                    {/* profile image */}
                    <img className="h-7 w-7 object-cover rounded-full inline" src="../../public/assets/gallery/events/sample1.png" />
                ...
                <div className="inline-block items-center py-1 pr-5"> {/* people */}
                    ...
                    <img className="h-7 w-7 object-cover rounded-full inline -ml-2.5" src="../../public/assets/gallery/events/sample1.png" />
